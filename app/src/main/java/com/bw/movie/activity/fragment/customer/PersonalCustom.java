package com.bw.movie.activity.fragment.customer;
...
public class PersonalCustom extends ScrollView {
    ...
    public PersonalCustom(Context context) {
        super(context);
    }

    public PersonalCustom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PersonalCustom(Context context, AttributeSet attrs, int defStyleAttr) {
